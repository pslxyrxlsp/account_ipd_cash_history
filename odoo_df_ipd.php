...
class PostgreSQL
{
    ...
    public function beginTransaction()
    {
        ...
        $this->query("BEGIN; SET client_encoding=UTF8; SET DateStyle TO 'ISO'; SET TRANSACTION ISOLATION LEVEL READ COMMITTED; ");
...
class ExportOdooIpd {
    ...
    private function IpdReceiptDoctorFeesDetail($company, $receipt_header)
    {
        $sql = "SELECT ex.* 
                ...
                WHERE 
                    ex.ipdstatus = 'I' AND 
                    ex.exam_date = '25681106' AND 
                    ex.docc_code <> 'MH9999' AND
                    (ex.reverse_stat IS NULL OR ex.reverse_stat = '') ";
    }
